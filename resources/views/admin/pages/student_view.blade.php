                    ...
                    <div class="about-info">
                        ...
                        <div class="media mt-3  d-flex">
                            ...
                            <ul>
                                    ...
                                    <li>
                                        <span class="title-span">Birth Date : </span>
                                        <span class="info-span">{{$users->birth}}</span>
                                    </li>
                                    <li>
                                        <span class="title-span">Class : </span>
                                        <span class="info-span">{{$users->class}}</span>
                                    </li>
                                    <li>
                                        <span class="title-span">Join Date : </span>
                                        <span class="info-span">{{$users->join}}</span>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <span class="info-span">{{$users->mother_name}}</span>
                                    </li>
